...
const RangeSlider = ({sliderWidth, min, max, step, onValueChange, firstPosition, secondPosition}) => {
  ...
  useEffect(()=>{
    if(firstPosition || secondPosition){
      position.value = firstPosition
      position2.value = secondPosition
    }
  },[])
  ...
  // this line for Reanimated from v3.5.0
